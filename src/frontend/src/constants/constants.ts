...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the AgentsTrail AI documentation for more information on how to write your own component.";
...
export const API_PAGE_PARAGRAPH =
  "Your secret AgentsTrail AI API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "AgentsTrail AI Chat";
...
export const STORE_TITLE = "AgentsTrail AI Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your AgentsTrail AI API key.";
